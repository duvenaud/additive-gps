...
view(azel);
hold on;
plot3(X(:,1), X(:,2), y + up_offset, 'wx', 'Linewidth', line_width, 'Markersize', markersize);   % show the data
...
%save2pdf('poster_1st_order_censored_ard.pdf', gcf, dpi, true );
...
zlim(zrange);
title('additive');
%save2pdf('poster_1st_order_censored_add.pdf', gcf, dpi, true );
...
zlim(zrange);
title('Truth');
%save2pdf('poster_1st_order_censored_truth.pdf', gcf, dpi, true );

figure; % subplot('position',[0 0 1 1]);
h = plot3(X(:,1), X(:,2), y + up_offset, 'b.', 'Linewidth', 2);   % show the data
xlim( [-2 2] );
ylim( [-2 2] );
%view(2)
%axis off
...
line([censor_threshold censor_threshold], [ censor_threshold 2 ], [20 20], 'LineWidth',line_width,'Color',[0 0 0] ); hold on;
line([censor_threshold 2], [ censor_threshold censor_threshold ], [20 20], 'LineWidth',line_width,'Color',[0 0 0] );
%save2pdf('poster_1st_order_censored_data.pdf', gcf, dpi, true );
...
%save2pdf('poster_1st_order_censored_d1d2.pdf', gcf, dpi, true );
