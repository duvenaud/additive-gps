...
figure;
plot_1st_order_interactions( X, y, hyp, covfunc, meanfunc, likfunc, inference, 4 )
xlabel(feature_names{4})
ylabel('Strength')
save2pdf('interpretable_1st_order1.pdf', gcf, 600, true );

figure;
plot_1st_order_interactions( X, y, hyp, covfunc, meanfunc, likfunc, inference, 8 )
xlabel(feature_names{8})
ylabel('Strength')
save2pdf('interpretable_1st_order2.pdf', gcf, 600, true );

figure;
plot_2nd_order_interactions( X, y, hyp, covfunc, meanfunc, likfunc, inference, 4, 8 )
xlabel(feature_names{4})
ylabel(feature_names{8})
zlabel('Strength')
%save2pdf('interpretable_2nd_order1.pdf', gcf, 600, true );
