function [lengthscales, scaled_order_variances] = sort_additive_hypers_lo( D, log_cov )
...
for d = 1:nr    
    ...
    scaling_factors(d) = covADD({d,'covSEiso_length'}, [log_cov(1:D), log(1)], zeros(1,D));
 end
